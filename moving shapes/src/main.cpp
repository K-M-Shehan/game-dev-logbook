...
int main(int argc, char* argv[]) 
{
  ...
  // let's makea shape that we will draw to the screen
  ...
  // text character size is in pixels, so move the text up from the bottom by its height by the height of the font
  ...
  while (window.isOpen()) 
  {
    ...
    // imgui uses 0-1 floar for colors, sfml uses 0-255 for colors
    ...
    // basic rendering functions calls 
